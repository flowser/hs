...
<script>
    ...
    export default {
        ...
        computed:{
            ...
            Bureau(){
                console.log(this.$store.getters.Specificbureau)
               return this.$store.getters.Specificbureau//reminder to updater index
            },
            Director(){
                console.log(this.$store.getters.Specificbureaudirectors)
               return this.$store.getters.Specificbureaudirectors//reminder to updater index
            },
            Admin(){
                console.log(this.$store.getters.Specificbureauadmins)
               return this.$store.getters.Specificbureauadmins//reminder to updater index
            },
            About(){
                        ...
                        //  console.log(response.data)
                         toast({
                            ...
                            title: 'Director Created successfully'
                             ...
                             this.$store.dispatch('SpecificbureauDirectorById', this.$route.params.id);
                            this.directorform.reset()
